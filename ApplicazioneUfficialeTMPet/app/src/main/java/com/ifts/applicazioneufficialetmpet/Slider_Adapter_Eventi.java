...
public class Slider_Adapter_Eventi extends PagerAdapter {

    private List<Slider_Eventi> sliders_eventi;
    private LayoutInflater inflater;
    private Context context;

    public Slider_Adapter_Eventi(List<Slider_Eventi> sliders_eventi, Context context) {
